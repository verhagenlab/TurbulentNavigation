function [x y xnl ynl xnr ynr theta odorSignall odorSignalr,conc_l,conc_r,capTime,success,randStart , baselineR , baselineL] = robot_test_B(x_start,y_start, theta_start, capRadius, varargin)
%ROBOT_TEST
...
LR1 = 0; % initialize left/right average
LR2 = 0; % initialize  left/right average
...
while t < t_final/dt
    ...
    elseif dWall(4) < distThres & abs(angdiff(pi/2, theta(t-1))) < pi/2
        ...
        if dLR > odorThres/4 % Go straight
            for t = t+1:t+2
                % Update position forward
                [theta(t), x(t),y(t),xnl(t),xnr(t),ynl(t),ynr(t)]= moveForward(theta(t-1), x(t-1),y(t-1),l,gam,v_move,dt);
                % Update odor signal
        ...
        elseif RealL-RealR > odorThres/2
            t = t+1;
            % Update heading left
            [theta(t), x(t),y(t),xnl(t),xnr(t),ynl(t),ynr(t)]= turnLeft(theta(t-1), x(t-1),y(t-1),l,gam,theta_inc);
            % Update odor signal
        ...
        elseif RealR-RealL > odorThres/2
            t = t+1;
            % Update heading right
            [theta(t), x(t),y(t),xnl(t),xnr(t),ynl(t),ynr(t)]= turnRight(theta(t-1), x(t-1),y(t-1),l,gam,theta_inc);
            % Update odor signal
